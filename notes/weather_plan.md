...
- Zone set *(2026-07-24: expanded from the initial Salish Sea 9 to wrap all of Vancouver Island)*:
  ...
  - *(2026-07-24, north-coast expansion for Prince Rupert / Langara Point stations — 21 zones total)*: `001230` Douglas Channel, `001241`/`001242` Hecate Strait north/south halves, `001250` Dixon Entrance East (Prince Rupert waters), `001261`/`001262` Dixon Entrance West east/west of Langara, `001271`/`001272` West Coast Haida Gwaii north/south halves. All these half-pairs tile cleanly (single-axis splits) — no QC-Sound-style handling needed. Deliberately excluded: Bowie and Explorer (far offshore). Known ECCC gap: the Inside Passage inner channels (Grenville, Finlayson, etc.) have no marine forecast zone at all.
